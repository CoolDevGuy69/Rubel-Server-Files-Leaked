          ...
          <div class="row">
            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php 
                  $grab = null;
                  $sql12 = "SELECT COUNT(*) FROM `tokens` WHERE `UID` LIKE '%$grab%'";
                  $resulto = mysqli_query($conn,$sql12);
                  $rows1 = mysqli_fetch_row($resulto);
                    echo $rows1[0];
                     ?>
...
// mysql connection
$hostname = "localhost";
$username = "id18075991_dead_noob1";
$password = "Ogd_?!NyUhf<5Mvc";
$dbname = "id18075991_dead_noob";


$con = mysqli_connect($hostname, $username, $password, $dbname) or die("Error: " . mysqli_error($con));

// fetch records
$result = @mysqli_query($con, "SELECT * FROM tokens ORDER BY id DESC") or die("Error: " . mysqli_error($con));
            ...
            <table class="table">
                ...
                <tr>
                   ...
                   ?> </td>
                    ...
                    if(strtotime(date("Y/m/d")) < strtotime($date9)) echo "Active"; else { echo "Expired";} }?></td>
